...
public abstract class JDBCSupport implements PersistenceSupport {
     ...
     * @throws FindException an error occurred
     ...
     * object
     * @throws FindException the specified class could not
     * be loaded
     */
     ...
     * @throws FindException the SQL could not be built
     */
     ...
     * @throws FindException a join could not be constructed
     */
     ...
     * @throws FindException the clause could not be
     * built
     */
     ...
     * @throws FindException the field could not be mapped
     */
